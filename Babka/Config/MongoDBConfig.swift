...
//func loadAppConfig() -> MongoDBConfig {
...
//        return MongoDBConfig(appId: appId, baseUrl: baseUrl, atlasUrl: atlasUrl as? String)
//    } else {
//        return MongoDBConfig(appId: appId, baseUrl: baseUrl, atlasUrl: nil)
//    }
//}
